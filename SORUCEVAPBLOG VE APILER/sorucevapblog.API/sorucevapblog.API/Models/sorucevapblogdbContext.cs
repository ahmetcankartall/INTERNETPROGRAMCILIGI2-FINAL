...
{
    public partial class sorucevapblogdbContext : DbContext
    {
        public sorucevapblogdbContext()
        {
        }

        public sorucevapblogdbContext(DbContextOptions<sorucevapblogdbContext> options)
            : base(options)
        {
        }
